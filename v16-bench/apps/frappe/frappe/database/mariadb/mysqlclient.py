...
class MariaDBConnectionUtil:
	...
	def get_connection_settings(self) -> dict:
		...
		elif os.path.exists("/var/run/mysqld/mysqld.sock") and (not self.host or self.host in ("localhost", "127.0.0.1")):
			conn_settings["unix_socket"] = "/var/run/mysqld/mysqld.sock"
		else:
